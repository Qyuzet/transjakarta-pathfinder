            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>
                      Interactive visualization of the TransJakarta bus network
                      using real geographical data
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-primary mr-2 mt-0.5" />
                    <span>
                      Implementation of Dijkstra&apos;s algorithm for optimal
                      path finding
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-primary mr-2 mt-0.5" />
                    <span>
                      Step-by-step algorithm visualization to understand how
                      Dijkstra works
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-primary mr-2 mt-0.5" />
                    <span>
                      Comprehensive documentation about the algorithm and its
                      application
                    </span>
                  </li>
                </ul>
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>
                    Demonstrate how graph algorithms work in real-world
                    scenarios
                  </li>
                  <li>
                    Visualize the step-by-step execution of Dijkstra&apos;s
                    algorithm
                  </li>
                  <li>
                    Analyze the algorithm&apos;s performance and complexity
                  </li>
                  <li>
                    Show the practical application of algorithms in
                    transportation systems
                  </li>
                  <li>
                    Provide an interactive learning tool for algorithm education
                  </li>
                </ul>
              </div>
            </CardContent>
            ...
            <CardContent>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      <strong>Route Finder:</strong> The main interface for
                      selecting stations and finding optimal routes
                    </li>
                    <li>
                      <strong>Map Visualization:</strong> Displays the
                      TransJakarta network and routes on a geographic map
                    </li>
                    <li>
                      <strong>Algorithm Visualization:</strong> Shows
                      step-by-step execution of Dijkstra&apos;s algorithm
                    </li>
                    <li>
                      <strong>Performance Metrics:</strong> Displays statistics
                      about the algorithm&apos;s execution
                    </li>
                    <li>
                      <strong>Documentation:</strong> Comprehensive information
                      about the algorithm and the project
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      <strong>Next.js:</strong> React framework for the
                      application
                    </li>
                    <li>
                      <strong>React:</strong> Library for building user
                      interfaces
                    </li>
                    <li>
                      <strong>Leaflet:</strong> Map visualization library
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>shadcn/ui:</strong> Component library based on
                      Radix UI
                    </li>
                    <li>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                ...
                and Next.js. Here&apos;s a breakdown of the key components and
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      <strong>RouteFinder:</strong> Main component for station
                      selection and route calculation
                    </li>
                    <li>
                      <strong>InteractiveMap:</strong> Map display using Leaflet
                      for geographic visualization
                    </li>
                    <li>
                      <strong>AnimatedAlgorithmSteps:</strong> Visualization of
                      Dijkstra algorithm execution
                    </li>
                    <li>
                      <strong>AlgorithmMetrics:</strong> Display of performance
                      statistics
                    </li>
                    <li>
                      <strong>Documentation Pages:</strong> Information about
                      the project and algorithm
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      <strong>Graph Data Structure:</strong> Representation of
                      the TransJakarta network
                    </li>
                    <li>
                      <strong>Dijkstra Algorithm:</strong> Implementation for
                      finding shortest paths
                    </li>
                    <li>
                      <strong>Priority Queue:</strong> Efficient data structure
                      for the algorithm
                    </li>
                    <li>
                      <strong>Geographical Calculations:</strong> Distance
                      calculation between stations
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      <strong>Static TransJakarta Data:</strong> Simplified
                      representation of stations and routes
                    </li>
                    <li>
                      <strong>Algorithm Step Recording:</strong> Capture of
                      intermediate states for visualization
                    </li>
                    <li>
                      <strong>Route Path Storage:</strong> Storage of calculated
                      optimal paths
                    </li>
                  </ul>
                </div>
...
└── public/
    └── ...                         # Static assets`}</code>
          ...
          <Card>
            ...
            <CardContent>
              <p>
                The application uses the following data structures to represent
                the TransJakarta network:
              </p>
  ...
  spaceComplexity: string;  // Space complexity info
        ...
        <TabsContent value="algorithm" className="space-y-6 mt-6">
          <Card>
            ...
            <CardContent>
              <p>
                Our implementation of Dijkstra&apos;s algorithm is specifically
                tailored for the TransJakarta network. Here are the key aspects
  ...
  isEmpty(): boolean {
    return this.items.length === 0;
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    For simplicity, we use a basic priority queue implementation
                    with array sorting. In a production system, a more efficient
                    implementation like a binary heap would be preferable for
                    large networks.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ol className="list-decimal list-inside mt-2 space-y-1">
                    <li>
                      Initialize distances (all to Infinity except source node
                      to 0)
                    </li>
                    ...
                    <li>
                      ...
                      <ul className="list-disc list-inside ml-6 mt-1">
                        ...
                        <li>
                          For each neighboring node, calculate a potential new
                          distance
                        </li>
                        <li>
                    ...
                    <li>
                      Return the result with path, distance, and steps for
                      visualization
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1">
                    A unique aspect of our implementation is the recording of
                    each algorithm step for educational visualization:
                  </p>
                  <pre className="bg-muted p-4 rounded-md overflow-x-auto mt-2 text-sm">
...
steps.push({
  ...
  previousNodes: { ...previousNodes },
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    This allows us to replay the algorithm execution and show
                    how Dijkstra progressively explores the graph to find the
                    optimal path.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-1">
                  Edge weights (travel times) are calculated based on the
                  geographic distance between stations:
                </p>
                <pre className="bg-muted p-4 rounded-md overflow-x-auto mt-2 text-sm">
  ...
  return {
    ...
    distance,
          ...
          <Card>
            ...
            <CardContent>
              <p>
                The algorithm visualization component is a key educational
                feature of this project. It shows step-by-step how
                Dijkstra&apos;s algorithm explores the graph:
              </p>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      <strong>Unvisited nodes:</strong> Shown in light gray
                    </li>
                    <li>
                      <strong>Visited nodes:</strong> Shown in blue
                    </li>
                    <li>
                      <strong>Current node:</strong> Shown in orange (actively
                      being processed)
                    </li>
                    <li>
                      <strong>Path nodes:</strong> Shown in green (final
                      shortest path)
                    </li>
                  </ul>
                  <p className="mt-2 text-sm text-muted-foreground">
                    Each node displays its ID, name, and current distance value,
                    allowing users to see how distances are updated during
                    algorithm execution.
                  </p>
                </div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-1">The metrics component displays:</p>
                <ul className="list-disc list-inside mt-2 space-y-1">
        ...
        <TabsContent value="usage" className="space-y-6 mt-6">
          <Card>
            ...
            <CardContent>
              <p>
                This guide explains how to use the TransJakarta Route Finder
                application:
              </p>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <ol className="list-decimal list-inside mt-2 space-y-2">
                    <li>
                      Navigate to the <strong>Route Finder</strong> page (home
                      page)
                    </li>
                    <li>
                      Select a <strong>Start Station</strong> from the dropdown
                      menu
                    </li>
                    <li>
                      Select an <strong>End Station</strong> from the dropdown
                      menu
                    </li>
                    <li>
                      Click the <strong>Find Optimal Route</strong> button
                    </li>
                    <li>
                      View the results on the map and in the Route Details panel
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    ...
                    <li>
                      When a route is found, the optimal path is highlighted
                    </li>
                    <li>
                      The start station is marked with an &apos;A&apos; icon
                    </li>
                ...
                <div>
                  ...
                  <ol className="list-decimal list-inside mt-2 space-y-2">
                    <li>
                      After finding a route, click the{" "}
                      <strong>Algorithm Visualization</strong> tab
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      Visit the <strong>Algorithm Analysis</strong> page to
                      learn about:
                      <ul className="list-disc list-inside ml-6 mt-1">
                    ...
                    <li>
                      Check the <strong>Documentation</strong> page for:
                      <ul className="list-disc list-inside ml-6 mt-1">
          ...
          <Card>
            ...
            <CardContent>
              <p>To get the most out of this educational tool:</p>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      Start with the <strong>Algorithm Analysis</strong> page to
                      understand the theoretical concepts
                    </li>
                    <li>
                      Pay attention to how the algorithm always selects the node
                      with the minimum known distance
                    </li>
                    <li>
                      Notice how distances are updated when shorter paths are
                      discovered
                    </li>
                    <li>
                      Observe how the algorithm stops once the destination is
                      reached
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-medium">
                    Effective Visualization Study
                  </h3>
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      Use step-by-step mode to carefully observe each algorithm
                      step
                    </li>
                    <li>
                      Pay attention to which nodes are being visited and in what
                      order
                    </li>
                    <li>
                      Watch how the distance values change as shorter paths are
                      found
                    </li>
                    <li>
                      Try different station combinations to see how the
                      algorithm behaves
                    </li>
                    <li>
                      Compare the number of nodes explored to the length of the
                      final path
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      Try finding routes between distant stations to see how the
                      algorithm handles larger searches
                    </li>
                    <li>
                      Compare routes between adjacent stations and see if the
                      algorithm behaves differently
                    </li>
                    <li>
                      Look for cases where the geographically shorter route
                      isn&apos;t chosen due to the weighted graph
                    </li>
                    <li>
                      Study the performance metrics for different routes to
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Remember that this is an educational tool with simplified
                      data. Real-world transit routing systems incorporate many
                      additional factors such as real-time bus locations,
                      traffic conditions, transfer times, and multiple route
                      options. However, the core principles of finding optimal
                      paths in weighted graphs remain the same across
                      applications.
                    </p>
                  </div>
                </div>
